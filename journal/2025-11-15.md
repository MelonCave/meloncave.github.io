This might be a total waste of time ... but we try things ... so we installed [Browser OS](https://github.com/AncientGuy/BrowserOS), which an an AI-powered browser that turns your words into actions and described as privacy-first alternative to privacy-first alternative to [ChatGPT Atlas](https://chatgpt.com/atlas), [Perplexity Comet](https://www.perplexity.ai/comet), [Dia](https://www.diabrowser.com/) ... OR even Chrome
