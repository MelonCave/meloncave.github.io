...
## Understanding the ***GROWING*** "AI software dominance" of NVIDIA's CUDA ecosystem

*{NOTE: AMD ROCm lag behind in NVIDIA is bad enough; the AI software lag is WORSE for Apple's AI ecosystem. Apple might have new hardware advantages and it unquestioning backward-looking fanbase that is still enamored by Steve Jobs, but Apple has even less AI developer mindshare than AMD in gaming development community.}*
